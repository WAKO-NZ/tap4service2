  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen flex flex-col items-center bg-gray-900 text-white p-[clamp(1rem,4vw,2rem)]">
        ...
        <div className="fixed bottom-4 left-0 right-0 flex justify-center space-x-[clamp(0.125rem,0.5vw,0.25rem)] z-20 flex-wrap gap-[clamp(0.125rem,0.5vw,0.25rem)]">
          <Link
            to="/"
            className="bg-gray-600 text-white text-[clamp(0.5rem,1.5vw,0.625rem)] font-medium py-[clamp(0.125rem,0.5vw,0.25rem)] px-[clamp(0.25rem,1vw,0.375rem)] rounded-md"
          >
            Test: Page 1
          </Link>
          <Link
