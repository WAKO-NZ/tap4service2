...
const theme = createTheme({
  ...
  components: {
    MuiPopper: {
      defaultProps: {
        disablePortal: true, // Prevent popper from rendering outside root
      },
    },
    MuiSelect: {
      defaultProps: {
        autoFocus: false, // Prevent auto-focus on Select
      },
    },
    MuiTextField: {
      defaultProps: {
        autoFocus: false, // Prevent auto-focus on TextField
      },
    },
  },
});
